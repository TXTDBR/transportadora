 ...
 * @author User
 */
public class FuncionarioRelatorioForm extends javax.swing.JDialog {
    private FuncionarioTabela tblFuncionario = new FuncionarioTabela();
    /**
     * Creates new form FuncionarioTabela
     */
    public FuncionarioRelatorioForm(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        tabelaFuncionario.setModel(tblFuncionario);
        loadTable();
    }
    ...
    private void initComponents() {
        ...
        setTitle("Relatório Funcionários - Sistema Controle");
        ...
        txtPesquisar.setToolTipText("Pesquisar Funcionario...");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FuncionarioRelatorioForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FuncionarioRelatorioForm dialog = new FuncionarioRelatorioForm(new javax.swing.JFrame(), true);
    ...
    public void loadTable(){
            ...
            tabelaFuncionario.getColumnModel().getColumn(1).setPreferredWidth(190);
            ...
            tabelaFuncionario.getColumnModel().getColumn(2).setResizable(true);
            tabelaFuncionario.getColumnModel().getColumn(3).setPreferredWidth(100);
            tabelaFuncionario.getColumnModel().getColumn(3).setResizable(true);
            tabelaFuncionario.getColumnModel().getColumn(4).setPreferredWidth(150);
            tabelaFuncionario.getColumnModel().getColumn(4).setResizable(true);
